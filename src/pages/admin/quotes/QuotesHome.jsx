...
import { QuotesCard, CreateFormModal } from '../../../components';
         ...
         <div className="min-w-full bg-gray-200">
            <div className="bg-white min-w-full flex items-center justify-between px-6 py-1">
               <div className="flex flex-col justify-between px-6 py-1">
                  <span className="text-2xl text-purplePz font-bold">Cotizaciones</span>

                  <span className="text-xs font-bold">{`Admin > Cotizaciones`}</span>
               </div>
