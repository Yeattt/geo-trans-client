         ...
         <div className="w-3/3 h-auto bg-primary rounded-md">
            ...
            <div className="w-full h-[calc(100% - 55px)] bg-white px-7 py-5">
               <div class="p-6 text-center">
                  ...
                  <button data-modal-hide="popup-modal" type="button" className="text-white bg-red hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2" onClick={() => onDelete(module.id)}>
                     Si, Seguro
                  </button>
