   ...
   return (
      <>
         <div className="flex flex-col md:flex-row items-center justify-around">
            <div className="bg-gradient-to-r from-primary to-primary rounded-md h-32 md:w-[27%] flex flex-col items-center justify-center px-6 py-4 mb-4 md:mb-0">
            ...
            <div className="bg-gradient-to-r from-primary to-primary rounded-md h-32 md:w-[27%] flex flex-col items-center justify-center px-6 py-4">
               <div className="flex flex-row justify-center items-center">
                  <div className="text-xl flex items-center justify-center">
                     <span className="border-[2.5px] border-gray-300 bg-white w-16 h-16 rounded-full flex justify-center items-center mr-6">
